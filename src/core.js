...
class VueI18n {
  ...
  _initVM (data: {
    ...
    const silent = this._vue.config.silent
    this._vue.config.silent = true
    this._vm = new this._vue({ data })
    this._vue.config.silent = silent
  }
